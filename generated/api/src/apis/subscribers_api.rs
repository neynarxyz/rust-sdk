...
pub async fn fetch_subscribed_to_for_fid(
    configuration: &configuration::Configuration,
    params: FetchSubscribedToForFidParams,
) -> Result<models::SubscribedToResponse, Error<FetchSubscribedToForFidError>> {
    ...
    req_builder = req_builder.query(&[(
        ...
        &params.subscription_provider.to_string(),
    )]);
...
pub async fn fetch_subscribers_for_fid(
    configuration: &configuration::Configuration,
    params: FetchSubscribersForFidParams,
) -> Result<models::SubscribersResponse, Error<FetchSubscribersForFidError>> {
...
pub async fn fetch_subscription_check(
    configuration: &configuration::Configuration,
    params: FetchSubscriptionCheckParams,
) -> Result<models::SubscriptionCheckResponse, Error<FetchSubscriptionCheckError>> {
...
pub async fn fetch_subscriptions_for_fid(
    configuration: &configuration::Configuration,
    params: FetchSubscriptionsForFidParams,
) -> Result<models::SubscriptionsResponse, Error<FetchSubscriptionsForFidError>> {
    let uri_str = format!(
