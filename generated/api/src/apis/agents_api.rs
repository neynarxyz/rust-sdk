...
pub async fn create_transaction_pay_frame(configuration: &configuration::Configuration, params: CreateTransactionPayFrameParams) -> Result<models::TransactionFrameResponse, Error<CreateTransactionPayFrameError>> {
...
pub async fn fetch_user_interactions(configuration: &configuration::Configuration, params: FetchUserInteractionsParams) -> Result<models::FetchUserInteractions200Response, Error<FetchUserInteractionsError>> {
...
pub async fn lookup_cast_conversation_summary(configuration: &configuration::Configuration, params: LookupCastConversationSummaryParams) -> Result<models::ConversationSummary, Error<LookupCastConversationSummaryError>> {
