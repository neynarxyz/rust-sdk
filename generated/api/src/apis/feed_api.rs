...
pub async fn fetch_casts_for_user(
    configuration: &configuration::Configuration,
    params: FetchCastsForUserParams,
) -> Result<models::FeedResponse, Error<FetchCastsForUserError>> {
...
) -> Result<models::FeedResponse, Error<FetchFeedError>> {
    ...
    if let Some(ref param_value) = params.embed_types {
        req_builder = match "csv" {
            "multi" => req_builder.query(
                &param_value
                    .into_iter()
                    .map(|p| ("embed_types".to_owned(), p.to_string()))
...
pub async fn fetch_feed_by_channel_ids(
    configuration: &configuration::Configuration,
    params: FetchFeedByChannelIdsParams,
) -> Result<models::FeedResponse, Error<FetchFeedByChannelIdsError>> {
...
pub async fn fetch_feed_by_parent_urls(
    configuration: &configuration::Configuration,
    params: FetchFeedByParentUrlsParams,
) -> Result<models::FeedResponse, Error<FetchFeedByParentUrlsError>> {
...
pub async fn fetch_feed_for_you(
    configuration: &configuration::Configuration,
    params: FetchFeedForYouParams,
) -> Result<models::FeedResponse, Error<FetchFeedForYouError>> {
...
pub async fn fetch_frames_only_feed(
    configuration: &configuration::Configuration,
    params: FetchFramesOnlyFeedParams,
) -> Result<models::FeedResponse, Error<FetchFramesOnlyFeedError>> {
...
pub async fn fetch_popular_casts_by_user(
    configuration: &configuration::Configuration,
    params: FetchPopularCastsByUserParams,
) -> Result<models::BulkCastsResponse, Error<FetchPopularCastsByUserError>> {
...
pub async fn fetch_replies_and_recasts_for_user(
    configuration: &configuration::Configuration,
    params: FetchRepliesAndRecastsForUserParams,
) -> Result<models::FeedResponse, Error<FetchRepliesAndRecastsForUserError>> {
    let uri_str = format!(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchRepliesAndRecastsForUserError> =
...
pub async fn fetch_trending_feed(
    configuration: &configuration::Configuration,
    params: FetchTrendingFeedParams,
) -> Result<models::FeedResponse, Error<FetchTrendingFeedError>> {
...
pub async fn fetch_user_following_feed(
    configuration: &configuration::Configuration,
    params: FetchUserFollowingFeedParams,
) -> Result<models::FeedResponse, Error<FetchUserFollowingFeedError>> {
