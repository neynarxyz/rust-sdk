...
/// struct for passing parameters to the method [`register_account_on_chain`]
#[derive(Clone, Debug)]
...
/// struct for typed errors of method [`register_account_on_chain`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn register_account_on_chain(
    configuration: &configuration::Configuration,
