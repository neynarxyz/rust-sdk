...
*AppHostApi* | [**app_host_get_event**](docs/AppHostApi.md#app_host_get_event) | **GET** /farcaster/app_host/user/event | Get app host event
*AppHostApi* | [**app_host_get_user_state**](docs/AppHostApi.md#app_host_get_user_state) | **GET** /farcaster/app_host/user/state | Get the user's notification subscriptions
*AppHostApi* | [**app_host_post_event**](docs/AppHostApi.md#app_host_post_event) | **POST** /farcaster/app_host/user/event | Process app host event
