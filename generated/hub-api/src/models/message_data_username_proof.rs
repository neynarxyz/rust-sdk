...
pub struct MessageDataUsernameProof {
    ...
    #[serde(rename = "usernameProofBody")]
    pub username_proof_body: Box<models::UserNameProof>,
}
...
impl MessageDataUsernameProof {
    pub fn new(
        ...
        MessageDataUsernameProof {
            ...
            timestamp,
            network,
            username_proof_body: Box::new(username_proof_body),
        }
    }
}
