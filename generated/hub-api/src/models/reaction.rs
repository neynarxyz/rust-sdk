...
impl Reaction {
    pub fn new(hash: String, hash_scheme: models::HashScheme, signature: Vec<u8>, signature_scheme: models::SignatureScheme, signer: String, data: models::ReactionAllOfData) -> Reaction {
        Reaction {
            hash,
            hash_scheme,
            signature,
