...
impl LinkAddAllOfData {
    pub fn new(fid: i32, timestamp: i64, network: models::FarcasterNetwork, link_body: models::LinkBody, r#type: models::MessageType) -> LinkAddAllOfData {
        LinkAddAllOfData {
            fid,
            timestamp,
            network,
