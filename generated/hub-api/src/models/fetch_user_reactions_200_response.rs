...
pub struct FetchUserReactions200Response {
...
impl FetchUserReactions200Response {
    pub fn new(next_page_token: Vec<u8>, messages: Vec<models::Reaction>) -> FetchUserReactions200Response {
