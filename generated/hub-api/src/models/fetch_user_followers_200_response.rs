...
pub struct FetchUserFollowers200Response {
    ...
    pub messages: Vec<models::LinkAdd>,
}

impl FetchUserFollowers200Response {
    pub fn new(next_page_token: Vec<u8>, messages: Vec<models::LinkAdd>) -> FetchUserFollowers200Response {
