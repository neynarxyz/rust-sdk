...
pub struct FetchCastsMentioningUser200Response {
...
impl FetchCastsMentioningUser200Response {
    pub fn new(next_page_token: Vec<u8>, messages: Vec<models::CastAdd>) -> FetchCastsMentioningUser200Response {
