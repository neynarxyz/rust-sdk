...
pub async fn fetch_casts_by_parent(
    configuration: &configuration::Configuration,
    params: FetchCastsByParentParams,
) -> Result<models::FetchCastsByParent200Response, Error<FetchCastsByParentError>> {
...
pub async fn fetch_casts_mentioning_user(
    configuration: &configuration::Configuration,
    params: FetchCastsMentioningUserParams,
) -> Result<models::FetchCastsMentioningUser200Response, Error<FetchCastsMentioningUserError>> {
...
/// Fetch user's casts.
pub async fn fetch_users_casts(
    configuration: &configuration::Configuration,
    params: FetchUsersCastsParams,
) -> Result<models::FetchUsersCasts200Response, Error<FetchUsersCastsError>> {
...
pub async fn lookup_cast_by_hash_and_fid(
    configuration: &configuration::Configuration,
    params: LookupCastByHashAndFidParams,
) -> Result<models::CastAdd, Error<LookupCastByHashAndFidError>> {
