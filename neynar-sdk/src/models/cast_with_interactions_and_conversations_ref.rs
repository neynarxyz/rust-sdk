...
pub struct CastWithInteractionsAndConversationsRef {
    #[serde(rename = "object")]
    pub object: Object,
    #[serde(rename = "hash")]
    pub hash: String,
