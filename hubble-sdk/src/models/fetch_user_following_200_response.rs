...
pub struct FetchUserFollowing200Response {
...
impl FetchUserFollowing200Response {
    pub fn new(next_page_token: Vec<u8>, messages: Vec<models::LinkAdd>) -> FetchUserFollowing200Response {
