...
pub struct MessageDataUserDataAdd {
...
impl MessageDataUserDataAdd {
    ...
    pub fn new(fid: i32, timestamp: i64, network: models::FarcasterNetwork, user_data_body: models::UserDataBody) -> MessageDataUserDataAdd {
