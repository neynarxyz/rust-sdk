...
pub struct FetchCastReactions200Response {
...
impl FetchCastReactions200Response {
    pub fn new(next_page_token: Vec<u8>, messages: Vec<models::Reaction>) -> FetchCastReactions200Response {
