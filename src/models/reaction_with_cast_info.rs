...
impl ReactionWithCastInfo {
    pub fn new(reaction_type: ReactionType, cast: models::CastWithInteractions, reaction_timestamp: String, object: Object, user: models::UserDehydrated) -> ReactionWithCastInfo {
