...
pub struct RegisterSignerKeyReqBody {
...
impl RegisterSignerKeyReqBody {
    pub fn new(signer_uuid: String, signature: String, app_fid: i32, deadline: i32) -> RegisterSignerKeyReqBody {
